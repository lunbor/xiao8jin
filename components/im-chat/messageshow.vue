<template>
	<view class="m-item" :id="'message'+id">
		<view class="m-left">
			<image class="head_icon" src="http://hszt.tw186.com/uploads/img/homeHL.png" v-if="message.user=='home'"></image>
		</view>
		...
		<view class="m-right">
			<image class="head_icon" src="http://hszt.tw186.com/uploads/img/customerHL.png" v-if="message.user=='customer'"></image>
		</view>
	</view>
</template>
...
<style>
	...
	.m-content-head-home:before {
		...
		border-right: 15upx solid #fd5950;
		left: -26upx;
		width: 0;
		height: 0;
		position: absolute;
