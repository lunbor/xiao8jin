<template>
	<view>		
		<view class="contentbg">	
			<view class="content">
				<view class="list contentbg by-mb-30">	
					<view class="list-item pd20 tab_box " style="margin-top: 30upx;">
			...
			<view class="content tab_box">
				<view class="list contentbg">
							...
							<view class="uni-flex uni-row repay-fee" style="justify-content: space-between;">
								<view class="text uni-list-cell-left">预留金</view>
		...
		<view class="uni-common-mt uni-padding-wrap uni-common-mb">
			...
			<button type="warn" class="by-button-submit" disabled="true"  v-else>
...
<style>
	page {
		...
		.list-item .font-sg{ line-height: 60upx; font-weight: 500;font-size: 26upx;}
		
		
		
		/* .uni-timeline-item-divider::before, .uni-timeline-item-divider::after{width: 1px;} */
		.uni-timeline-item{padding-bottom: 10upx;}
		.uni-timeline-item .uni-timeline-item-divider{background-color: #e7c896;}
		.uni-timeline-item .uni-timeline-item-keynode {width: 200upx; line-height: 40upx; text-align: left;font-size: 26upx;color: #999;}
		.list-money{ text-align: center; color: #fe5d55; font-weight: 500;width: 200upx; line-height: 70upx;}
		.list-money text{ font-size: 30upx; font-weight: 500;}
		.mt15 {
			margin-top: 30upx;
		}
		.list-type{width: 220upx;text-align: right;color: #576175;font-size: 28upx; /* font-weight: 600; */line-height:70upx}
		...
		.title-time-btn{ height: 70upx; line-height: 70upx; text-align: center; border-top-right-radius: 50upx; border-bottom-right-radius: 50upx; 
		width: 180upx; color: #FFFFFF; background-color: #ffa13c;
