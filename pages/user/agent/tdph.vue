			...
			<view class="syph-top">
				<view class="uni-flex uni-row">
					<view class="by-flex text-c" v-for="(item,index) in list" :key="index" v-if="index<3" :class="'top-'+(index+1)">
							...
							<view class="ph-sy">{{item.usercount}}<text>人</text></view>
					</view>
			...
			<view class="syph-list" style="padding: 0 30upx;">
				<view class="uni-flex uni-row">
					...
					<view class="text-r money">
						<view class="fzhsy">{{item.usercount}}<text>人</text></view>
						<view class="fzhsy-jdh">累计推广</view>
					</view>
				</view>
			</view>
		</view>
...
<style>
	...
	.ph-sy text{font-size: 24upx;margin-left: 6upx;}
	...
	.fzhsy text{font-size: 24upx; margin-left: 6upx;}
</style>