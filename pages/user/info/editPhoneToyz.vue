	...
	<view>
		<view class="uni-padding-wrap">	
			<view class="uni-card by-card">
				<view class="uni-card-content">
					<view class="uni-form-item uni-column">
						<view class="with-fun">
							<input class="uni-input" type="number" placeholder="请填入新的手机号" v-model="mobile"/>
						</view>
					</view>
					<view class="uni-form-item uni-column">
						<view class="with-fun">
			...
			<view class="uni-common-mt">
				<button type="warn" class="by-button-submit" :loading="loading" @click="editPhone">提交修改</button>
			</view>
		</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			editPhone: function (e) {
				...
				const toverifyCode = this.toverifyCode;
				const that = this;
				try {
					if(this.loading){
						return;
